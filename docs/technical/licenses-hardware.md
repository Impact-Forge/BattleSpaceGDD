...
Artist-friendly animation authoring, rigging, retargeting, and runtime toolsâ€”together with a continually expanding modeling toolsetâ€”reduce iteration and eliminate round-tripping, speeding up the creative process. Create games and worlds with massive amounts of geometric detail with Nanite, a virtualized micropolygon geometry system, and Virtual Shadow Maps.

Directly import and replicate multi-million-polygon meshes while maintaining a real-time frame rateâ€”even at 60 fpsâ€”without any noticeable loss of fidelity.
...
Lumen is a fully dynamic global illumination and reflections solution that enables indirect lighting to adapt on the fly to changes to direct lighting or geometryâ€”for example, changing the sunâ€™s angle with the time of day or opening an exterior door.
...
With these tools, artists can develop and iterate on assetsâ€”including dense meshes, such as those generated using photogrammetry tools or by kitbashingâ€”directly within the Unreal Editor, saving time and reducing the potential for errors.
...
1. FLECS Projectiles (Name TBD)
2. BattlespaceOWSAPISubsystem&#x20;
3. GSEngineSubsystem&#x20;

## Online Services from Redpoint Games:&#x20;

1. Game Management Framework&#x20;
2. Replicated Sublevel Instances
3. Epic Online Services
4. Matchmaking&#x20;

## 20221220-DLSS-UE5.1-Plugins: &#x20;

1. DLSS -DLSSMoviePiplineSupport
2. NIS&#x20;
...
1. OWS Epic Online Services SDK
2. Steamworks SDK&#x20;
